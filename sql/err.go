...
const (
	...
	ERR_014_EXPIRED_PASSWORD			 = `014 Password is expired, please reset your password`
	ERR_015_INVALID_OTP						 = `015 Invalid OTP code`
	...
	ERR_307_FAILED_SEND_OTP_EMAIL          	 = `307 Failed to send OTP code, please contact`
